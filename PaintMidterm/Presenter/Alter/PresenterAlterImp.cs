...
{
    internal class PresenterAlterImp : IPresenterAlter
    {
        ViewPaint viewPaint;
        ...
        {
            //tìm ra những hình được chọn, đếm số lượng lớn hơn 1 thì nhóm lại với nhau
        ...
        {
            // tìm ra những hình được chọn mà là hình GroupShape
